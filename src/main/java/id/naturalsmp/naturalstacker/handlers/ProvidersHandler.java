...
import id.naturalsmp.naturalstacker.hooks.ConflictPluginFixer;
import id.naturalsmp.naturalstacker.hooks.CustomItemProvider;
import id.naturalsmp.naturalstacker.hooks.EconomyProvider;
import id.naturalsmp.naturalstacker.hooks.EconomyProvider_Default;
import id.naturalsmp.naturalstacker.hooks.EntityNameProvider;
import id.naturalsmp.naturalstacker.hooks.EntitySimilarityProvider;
import id.naturalsmp.naturalstacker.hooks.EntityTypeProvider;
import id.naturalsmp.naturalstacker.hooks.IDataSerializer;
import id.naturalsmp.naturalstacker.hooks.ItemEnchantProvider;
import id.naturalsmp.naturalstacker.hooks.RegionsProvider;
import id.naturalsmp.naturalstacker.hooks.SpawnersProvider;
import id.naturalsmp.naturalstacker.hooks.SpawnersProvider_Default;
import id.naturalsmp.naturalstacker.hooks.listeners.IEntityDeathListener;
import id.naturalsmp.naturalstacker.hooks.listeners.IEntityDuplicateListener;
import id.naturalsmp.naturalstacker.hooks.listeners.INameChangeListener;
import id.naturalsmp.naturalstacker.hooks.listeners.IStackedBlockListener;
import id.naturalsmp.naturalstacker.hooks.listeners.IStackedItemListener;
import id.naturalsmp.naturalstacker.listeners.PaperListener;
import id.naturalsmp.naturalstacker.listeners.ProvidersListener;
