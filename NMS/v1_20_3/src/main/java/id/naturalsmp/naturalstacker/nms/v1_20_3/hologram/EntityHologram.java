package id.naturalsmp.naturalstacker.nms.v1_20_3.hologram;
...
public class EntityHologram extends ArmorStand implements Hologram {
    ...
    public void setHologramName(String name) {
        super.setCustomName(org.bukkit.craftbukkit.v1_20_R3.util.CraftChatMessage.fromStringOrNull(name));
    }
    ...
    public org.bukkit.craftbukkit.v1_20_R3.entity.CraftEntity getBukkitEntity() {
        if (bukkitEntity == null) {
            bukkitEntity = new org.bukkit.craftbukkit.v1_20_R3.entity.CraftArmorStand((org.bukkit.craftbukkit.v1_20_R3.CraftServer) Bukkit.getServer(), this);
        }
        return bukkitEntity;
    }
