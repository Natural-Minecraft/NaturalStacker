...
import id.naturalsmp.naturalstacker.nms.v1_8_R3.spawner.StackedMobSpawner;
import id.naturalsmp.naturalstacker.nms.v1_8_R3.spawner.SyncedCreatureSpawnerImpl;
import id.naturalsmp.naturalstacker.nms.v1_8_R3.spawner.TileEntityMobSpawnerWatcher;
...
public final class NMSSpawnersImpl implements NMSSpawners {
    ...
    public void updateStackedSpawner(StackedSpawner stackedSpawner) {
        ...
        if (watcherToAdd != null) {
            worldServer.t(watcherToAdd.getPosition());
