package id.naturalsmp.naturalstacker.nms.v1_7_R4.entity;
...
public final class EntityHelper {
    ...
    public static net.minecraft.server.v1_7_R4.Entity createEntity(Location location, Class<? extends Entity> clazz) throws IllegalArgumentException {
        if (location != null && clazz != null) {
            World world = ((CraftWorld) location.getWorld()).getHandle();
            net.minecraft.server.v1_7_R4.Entity entity = null;
    ...
    public static void addEntity(net.minecraft.server.v1_7_R4.Entity entity, CreatureSpawnEvent.SpawnReason reason) throws IllegalArgumentException {
        if (entity == null)
