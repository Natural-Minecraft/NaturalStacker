...
public final class NMSEntitiesImpl implements NMSEntities {
    ...
    @Override
    public StackCheckResult areSimilar(id.naturalsmp.naturalstacker.utils.legacy.EntityTypes entityType, LivingEntity en1, LivingEntity en2) {
    ...
    public String getCustomName(org.bukkit.entity.Entity bukkitEntity, boolean withColors) {
        ...
        IChatBaseComponent chatBaseComponent = ((CraftEntity) bukkitEntity).getHandle().getCustomName();
