...
import id.naturalsmp.naturalstacker.nms.v1_16_R3.spawner.StackedMobSpawner;
import id.naturalsmp.naturalstacker.nms.v1_16_R3.spawner.SyncedCreatureSpawnerImpl;
import id.naturalsmp.naturalstacker.nms.v1_16_R3.spawner.TileEntityMobSpawnerWatcher;
...
public final class NMSSpawnersImpl implements NMSSpawners {
    ...
    public void updateStackedSpawners(org.bukkit.Chunk bukkitChunk) {
        ...
        for (TileEntity tileEntity : watchersToAdd) {
            worldServer.removeTileEntity(tileEntity.getPosition());
    ...
    public void updateStackedSpawner(StackedSpawner stackedSpawner) {
        ...
        if (watcherToAdd != null) {
            worldServer.removeTileEntity(watcherToAdd.getPosition());
