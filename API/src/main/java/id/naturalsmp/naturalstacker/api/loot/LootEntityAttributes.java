package id.naturalsmp.naturalstacker.api.loot;
...
public interface LootEntityAttributes {
    ...
    static LootEntityAttributes.Builder newBuilder(EntityType entityType) {
        return NaturalStackerAPI.getNaturalStacker().getSystemManager().createLootContextBuilder(entityType);
    }
    ...
    static LootEntityAttributes.Builder newBuilder(StackedEntity stackedEntity) {
        return NaturalStackerAPI.getNaturalStacker().getSystemManager().createLootContextBuilder(stackedEntity);
    }
    ...
    static LootEntityAttributes.Builder newBuilder(LivingEntity livingEntity) {
        return NaturalStackerAPI.getNaturalStacker().getSystemManager().createLootContextBuilder(livingEntity);
    }
    ...
    static LootEntityAttributes.Builder newBuilder(Entity entity) {
        return NaturalStackerAPI.getNaturalStacker().getSystemManager().createLootContextBuilder(entity);
    }
